...
public class RSSMain extends Activity {
    ...
    private static List<Content> myContent;
...
RSSMain.this.startActivity(intent);*/
            ...
            liste.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                                    ...
                                    intent.putExtra("URL",  XmlHandler.myContent.get(position).getUrl(position));
    ...
    public class ReadRssFeedTask extends AsyncTask<Void, Void, Void> {
                            ...
                            if(statusLine.getStatusCode() == 200){
                                    ...
                                    try{
                                            ...
                                            try{
                                                    ...
                                                    Log.e(TAG, "URL " + URL_RSS + " konnte nicht geöffnet werden!" + e.getMessage());
                                            }
                                    ...
                                    Log.i(RSSMain.class.getSimpleName(), "Der Server antwortet mit anderem Statuscode als 200.");
                            }
                    }else {
            ...
            protected void onExecute(Void result){
                    ...
                    liste.setAdapter(new CustomAdapter(RSSMain.this, android.R.layout.simple_list_item_activated_1, XmlHandler.myContent));
            }
            ...
            protected void onPostExecute(Void result){
                    ...
                    //fill list with data
                    ArrayList<Content> tester = XmlHandler.myContent;
